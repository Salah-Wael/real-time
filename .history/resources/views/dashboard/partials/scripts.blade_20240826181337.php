...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', ".notificationsIcon", function(){
            $.ajax({
                url: {!! json_encode(route('admin.notifications.read')) !!}, // Corrected to use JSON encode for URL string
                method: 'get',
                success: function(data){
                    $("#notificationsIconCounter").load(" #notificationsIconCounter > *");
                    $("#notificationsModal").load(" #notificationsModal > *");
        ...
        $(document).on('click', "#clearNotifications", function(){
            $.ajax({
                url: {!! json_encode(route('admin.notifications.clear')) !!}, // Corrected to use JSON encode for URL string
                method: 'get',
                success: function(data){
                    $("#notificationsIconCounter").load(" #notificationsIconCounter > *");
                    $("#notificationsModal").load(" #notificationsModal > *");
