<nav class="topnav navbar navbar-light">
    ...
    <ul class="nav">
        ...
        <li class="nav-item nav-notif">
            <a class="nav-link text-muted my-2 notifica" href="./#" data-toggle="modal" data-target=".modal-notif">
                <span class="dot dot-md bg-success"></span>
                <span class="fe fe-bell fe-16"></span>
                <span class="text-success">{{ count(Auth::guard('admin')->user()->unreadnotifications) }}</span>
            </a>
        </li>
                            ...
                            @forelse (Auth::guard('admin')->user()->notifications as $notification)
                                <div class="list-group-item @if($notification->unread()) bg-light @else bg-transparent @endif ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <small><strong>Register New User</strong></small>
